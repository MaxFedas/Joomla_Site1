 ...
 *
 * @modyfy		Stephan W. 3d-hobby-art.de, minBootstrap-{y} v1.0
 */
...
abstract class JHtmlIcon
{
	...
	public static function create($category, $params, $attribs = array(), $legacy = false)
	{
		...
		$output = '<span class="hasTooltip" data-toggle="tooltip" title="' . JHtml::tooltipText('COM_CONTENT_CREATE_ARTICLE') . '">' . $button . '</span>';
	...
	public static function email($article, $params, $attribs = array(), $legacy = false)
	{
		...
		$attribs['class']  = 'a-mail hasTooltip';
	...
	public static function edit($article, $params, $attribs = array(), $legacy = false)
	{
		...
		else
		{
			...
			$text = '<span class="uk-icon-edit"></span>&#160;' . JText::_('JGLOBAL_EDIT') . '&#160;';
		}

		$attribs['title']   = JText::_('COM_CONTENT_EDIT_ITEM');
		$attribs['class']  = 'a-edit hasTooltip';
		$output = JHtml::_('link', JRoute::_($url), $text, $attribs).'&#160;';
	...
	public static function print_popup($article, $params, $attribs = array(), $legacy = false)
	{
		...
		if ($params->get('show_icons'))
		{
			...
			else
			{
				...
				$text = '<span class="uk-icon-print"></span>&#160;' . JText::_('JGLOBAL_PRINT') . '&#160;';
			}
		}
		else
		{
		...
		$attribs['class']  = 'a-print hasTooltip';
		$attribs['onclick'] = "window.open(this.href,'win2','" . $status . "'); return false;";
	...
	public static function print_screen($article, $params, $attribs = array(), $legacy = false)
	{
		...
		return '<a title="' . $text . '" href="#" onclick="window.print();return false;">' . $text . '</a>';
	}
